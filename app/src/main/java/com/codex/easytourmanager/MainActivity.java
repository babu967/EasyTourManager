...
import com.codex.easytourmanager.fragments.AboutFragment;
import com.codex.easytourmanager.fragments.EventFragment;
import com.codex.easytourmanager.fragments.WeatherFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        nameView = headerView.findViewById(R.id.name_View);
        ...
        rootreference.child("user").child(user.getUid()).child("info").child("profileImageData")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        ...
                        Log.d("Firebase Error1", databaseError.getMessage());
                    }
                });
...
/*    @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        }else if (id == R.id.nav_shared_event) {

            Intent intent = new Intent(MainActivity.this, SharedEventActivity.class);
    ...
    private void loadAboutFragment() {
        ...
        fragmentTransaction.replace(R.id.event_container_layout, aboutFragment);
